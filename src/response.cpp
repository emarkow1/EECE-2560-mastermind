...
//  1-satbermacmar-1b
//
// This file contains the implementation of the "response" class which stores
// the # correct and incorrect as well as defines the overloaded operators ==
// and << to compare and print responses
...
{
    os << "Correct: " << response.getCorrect() << ", Incorrect: " 
    << response.getIncorrect();
    return os;
}